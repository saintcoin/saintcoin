...
unsigned int nTargetSpacing = 2 * 60; // 1 minute
...
const string strMessageMagic = "Saint Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Saint", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Heaven January 3 2018 Starting Saintcoin";
        CTransaction txNew;
        txNew.nTime = 1515007045;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1515007045;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 1108439 : 1108439;
        ...
        assert(block.hashMerkleRoot == uint256("0x1d4a23346fa412d28e6c0852bbabf182cf510d0c224f3d4946c4cfab61e9717d"));  // "merkleroot": "dfebe44f15784a4f7257a11f3c5329aad1246e221f7ef81dfd280bff2da28f91",
...
unsigned char pchMessageStart[4] = { 0x11, 0x5a, 0xde, 0x78 };
